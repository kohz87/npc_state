...
test('relationship history defaults to the dossier visible maximum and clamps safely', () => {
    assert.equal(RELATIONSHIP_HISTORY_DEFAULT, 8);
    assert.equal(RELATIONSHIP_HISTORY_MAX, 8);
    ...
    assert.equal(normalizeRelationshipHistoryLimit(99), 8);
});
